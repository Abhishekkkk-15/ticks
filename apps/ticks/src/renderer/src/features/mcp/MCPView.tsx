...
const ALL_TOOLS = [
  ...
  { name: 'create_folder', category: 'Write', description: 'Creates a nested folder in a workspace.' },
  ...
  { name: 'move_note', category: 'Write', description: 'Moves a note to a specific folder path.' },
